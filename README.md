<h1 align='center'>
  欢迎！Badges README.md-Profile项目的readme<kbd>中文翻译版</kbd>
</h1>

<p align='center'>
  使用这些好看的徽章让您的 README.md Profile更丰富美观.在<a href='https://github.com/alexandresanlim'>此处查看示例</a>
</p>
...
1. 查找一个你喜欢的徽章URL:
   ...
   - 你可以用 <kbd>Ctrl</kbd> <kbd>F</kbd> (Windows) 或者 <kbd>⌘</kbd> <kbd>F</kbd> (mac) 来查找你需要的徽章URL
...
- [徽章](#徽章)
  - [🧑🏼‍🏭 静态徽章](#-静态徽章)
    ...
    - [🌐 浏览器](#-浏览器-)
    - [🥅 工作/职业](#-工作职业-)
    - [⏱️ 工作流](#%EF%B8%8F-%E5%B7%A5%E4%BD%9C%E6%B5%81-)
    - [💻 开发环境](#-开发环境-)
  - [🔁 动态徽章](#-动态徽章)
...
<h1 align='center'>徽章</h1>

<h2 align='center'>🧑🏼‍🏭 静态徽章</h2>
...
动态徽章迁移到了[这个仓库](https://github.com/alexandresanlim/Badges4-README.md-Profile-Dynamic)
<br/>
<br/>
<br/>
...
2 - [Simple Icon在这](https://simpleicons.org/)获取图标和十六进制颜色 如果没有找到所需的图标, [在这](https://github.com/simple-icons/simple-icons/issues/new?assignees=&labels=new+icon&template=icon_request.yml)提交issue.
...
- {TEXT} = 粘贴你的徽章文字
- {HEX-COLOR} = 从 "Simple Icon" 中粘贴不带 “#”的十六进制颜色
- {LOGO-NAME} = "Simple Icon" 里的Logo名称
